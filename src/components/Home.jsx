...
import "./Home.css"; // Ensure this file exists and is properly linked
            ...
            <tr key={index}>
              ...
              <td className="cyberpunk-actions">
                <button
                  ...
                  onClick={() =>
                    setID(item.id, item.CompanyName, item.CompanyCategory, item.JDdate, item.Domain)
                  }
                >
                  Update
                </button>
                <button className="cyberpunk-btn delete" onClick={() => deleted(item.id)}>
                  Delete
                </button>
              </td>
            </tr>
